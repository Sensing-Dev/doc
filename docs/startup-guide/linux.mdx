...
<pre><code class="language-bash">sudo bash setup.sh --install-opencv {this_version.linux_version}
</code></pre>
...
Sensing-Dev v24.09 uses ion-contrib-python instead of ion-python. Therefore, please uninstall ion-python with the following command.
