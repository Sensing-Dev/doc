...
<div class="board">
<a class="card" href="https://github.com/Sensing-Dev/sensing-dev-installer/releases/download/v23.10.00/installer.ps1">DL Windows 64-bit Package</a>
</div></div>
...
Please DL the installer script at the top of the page or [here](https://github.com/Sensing-Dev/sensing-dev-installer/releases/download/v23.10.00/installer.ps1).
