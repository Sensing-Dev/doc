...
Also, v24.09 uses ion-contrib-python instead of ion-python. Therefore, please uninstall ion-python with the following command.
...
Then install aravis-python and gendc-python and ion-contrib-python to fully utilize
