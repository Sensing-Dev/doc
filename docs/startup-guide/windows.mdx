...
<Image img={require("./img/winusb-uninstall-uninstall.png")}/>

2. Click the checkbox and click uninstall device

<Image img={require("./img/winusb-uninstall-checkbox.png")} />

3. Open Action and click scan for hardware changes

<Image img={require("./img/winusb-uninstall-hardware.png")} />
