...
Please DL the installer script at the top of the page or [here](https://github.com/Sensing-Dev/sensing-dev-installer/releases/download/v24.01.00/installer.ps1).
