...
### Configuration
Please adjust the camera_name, pixelformat, width, height, framerate based on your requirements.  You can obtain these values by [arv-tool-0.8](../external/aravis/arv-tools) in Sensing-Dev software package
```python
