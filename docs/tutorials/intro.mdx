...
This section focus on ion-kit. If you would like tto know how to use the simple tools to control U3V cameras, please check **[Tools from Aravis](docs/external/aravis/arv-tools.md)**.
...
<div class="board">
<a class="card" href="obtain-device-info">Access and Display Device Info</a>
<a class="card" href="display-image">Get and display the images</a>
</div></div>
