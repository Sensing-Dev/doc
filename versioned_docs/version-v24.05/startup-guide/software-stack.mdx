...
| --------   | ------- | ------- |
| **Driver** | [libUSB (Linux)](#libusbwinusb) | [LGPL-2.1](https://github.com/libusb/libusb/blob/master/COPYING) |
| **Camera Acquisition Library** | [Aravis](#aravis) | [LGPL-2.1](https://github.com/AravisProject/aravis?tab=LGPL-2.1-1-ov-file) |
| **Image Processing Framework** | [ion-kit](#ion-kit) | [MIT](https://github.com/fixstars/ion-kit?tab=MIT-1-ov-file) |
| Language for Image Processing | [Halide](https://halide-lang.org/) | [MIT](https://github.com/halide/Halide/blob/main/LICENSE.txt) |
| Image Processing Library (used in Framework) | [OpenCV](https://opencv.org/) | [Apache 2 License](https://opencv.org/license/) |
| Data Parser/separator | [GenDC Sepatrator](https://github.com/Sensing-Dev/GenDC) | [MIT](https://github.com/Sensing-Dev/GenDC/tree/refactor/python?tab=License-1-ov-file) |
...
To learn how to use the aravis tools, check **[Tools from Aravis](docs/external/aravis/arv-tools.md)** section.
