...
This document describes the steps to install the Kizashi hardware and software development environment on Windows.

import '/src/css/home.css';
import {is_latest, latest_version, one_line_install, latest_installer_URL, one_line_powershell} from "@site/static/version_const/v240104.js"
import LangSwitcher from '@site/static/locale_const.js';
...
<LangSwitcher islatest={is_latest} version={latest_version}/>
