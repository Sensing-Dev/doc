...
You can open powershell terminal and type `.\installer.ps1 -user <username> v23.11.01` to install the SDK.
...
![before_installed](./img/before_installed.png)
...
1. Hit Windows key **&#8862;** or cIf your device is displaying as an unknown device, congratulations! The WinUSB driver has been successfully uninstalled!lick **&#8862;** at the corner of task bar to use start-menu.
