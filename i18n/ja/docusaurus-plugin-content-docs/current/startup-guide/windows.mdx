...
<div class="board">
<a class="card" href="https://github.com/Sensing-Dev/sensing-dev-installer/releases/download/v23.10.00-beta2/installer.ps1">Windows 64ビットパッケージをダウンロード</a>
</div></div>
...
ページのトップにあるインストーラースクリプトをダウンロードするか、[こちら](https://github.com/Sensing-Dev/sensing-dev-installer/releases/download/v23.10.00-beta2/installer.ps1)からダウンロードしてください。
