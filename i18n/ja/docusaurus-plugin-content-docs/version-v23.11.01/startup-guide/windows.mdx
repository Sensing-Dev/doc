...
PowerShellターミナルを開いて、`.\installer.ps1 -user <ユーザー名> v23.11.01`と入力して、SDKをインストールできます。
...
2. **[ここ](https://github.com/Sensing-Dev/sensing-dev-installer/releases/download/v23.11.01/installer-WinUSB.ps1)** and right-click to run it in PowerShell.**からスクリプトをダウンロードし、PowerShellで右クリックして実行してください。
