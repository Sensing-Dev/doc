...
| **カメラ取得ライブラリ** | [Aravis](#aravis) | [LGPL-2.1](https://github.com/AravisProject/aravis?tab=LGPL-2.1-1-ov-file) |
| **画像処理フレームワーク** | [ion-kit](#ion-kit) | [MIT](https://github.com/fixstars/ion-kit?tab=MIT-1-ov-file) |
| 画像処理言語 | [Halide](https://halide-lang.org/) | [MIT](https://github.com/halide/Halide/blob/main/LICENSE.txt) |
| 画像処理ライブラリ (フレームワーク内で使用) | [OpenCV](https://opencv.org/) | [BSD](https://opencv.org/license/) |
| データ処理ライブラリ| [GenDC Sepatrator](https://github.com/Sensing-Dev/GenDC) | [MIT](https://github.com/Sensing-Dev/GenDC/tree/refactor/python?tab=License-1-ov-file) |
...
ravisツールの使用方法については、**[Aravisのツール](../external/aravis/arv-tools.md)**セクションを確認してください。
